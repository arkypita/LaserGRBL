...
;Source: ".\LaserGRBL\bin\Release\SerialPort2.dll"; DestDir: "{app}"; Flags: ignoreversion
;Source: ".\LaserGRBL\bin\Release\SerialPort2.pdb"; DestDir: "{app}"; Flags: ignoreversion
