namespace LaserGRBL.RasterConverter
{
	partial class RasterToLaserForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.UDSpotRemoval = new LaserGRBL.UserControls.NumericInput.NumericUpDown();
			this.CbSpotRemoval = new System.Windows.Forms.CheckBox();
			this.label24 = new System.Windows.Forms.Label();
			this.label23 = new System.Windows.Forms.Label();
			this.UDOptimize = new LaserGRBL.UserControls.NumericInput.NumericUpDown();
			this.UDSmoothing = new LaserGRBL.UserControls.NumericInput.NumericUpDown();
			...
			this.UDFillingQuality = new LaserGRBL.UserControls.NumericInput.NumericUpDown();
			this.LblFillingLineLbl = new System.Windows.Forms.Label();
			this.UDDownSample = new LaserGRBL.UserControls.NumericInput.NumericUpDown();
		...
		private LaserGRBL.UserControls.NumericInput.NumericUpDown UDOptimize;
		...
		private LaserGRBL.UserControls.NumericInput.NumericUpDown UDFillingQuality;
