namespace LaserGRBL.UI.Forms.RasterConverter
{
	partial class SetupGrayscale
	{
		...
		private void InitializeComponent()
		{
			...
			this.GbParameters.Size = new System.Drawing.Size(222, 198);
			...
			this.TLP.Controls.Add(this.LblGrayscale, 0, 0);
			this.TLP.Controls.Add(this.CbMode, 1, 0);
			this.TLP.Controls.Add(this.TBRed, 1, 1);
			this.TLP.Controls.Add(this.LblRed, 0, 1);
			this.TLP.Controls.Add(this.LblBlue, 0, 3);
			this.TLP.Controls.Add(this.LblGreen, 0, 2);
			this.TLP.Controls.Add(this.label2, 0, 4);
			this.TLP.Controls.Add(this.TBGreen, 1, 2);
			this.TLP.Controls.Add(this.TbBright, 1, 4);
			this.TLP.Controls.Add(this.TBBlue, 1, 3);
			this.TLP.Controls.Add(this.TbContrast, 1, 5);
			this.TLP.Controls.Add(this.label3, 0, 5);
			this.TLP.Controls.Add(this.CbThreshold, 0, 7);
			this.TLP.Controls.Add(this.TbThreshold, 1, 7);
			this.TLP.Controls.Add(this.TBWhiteClip, 1, 6);
			this.TLP.Controls.Add(this.label4, 0, 6);
			...
			this.TLP.RowStyles.Add(new System.Windows.Forms.RowStyle());
			this.TLP.RowStyles.Add(new System.Windows.Forms.RowStyle());
			this.TLP.Size = new System.Drawing.Size(216, 179);
			this.TLP.TabIndex = 0;
			// 
			// LblGrayscale
			// 
			...
			this.LblRed.Location = new System.Drawing.Point(3, 29);
			...
			this.LblBlue.Location = new System.Drawing.Point(3, 73);
			...
			this.LblGreen.Location = new System.Drawing.Point(3, 51);
			...
			this.TBGreen.Location = new System.Drawing.Point(62, 47);
			this.TBGreen.Margin = new System.Windows.Forms.Padding(0);
			this.TBGreen.Maximum = 160;
			this.TBGreen.Minimum = 40;
			this.TBGreen.Name = "TBGreen";
			this.TBGreen.Size = new System.Drawing.Size(154, 22);
			...
			this.TbBright.Location = new System.Drawing.Point(62, 91);
			this.TbBright.Margin = new System.Windows.Forms.Padding(0);
			this.TbBright.Maximum = 160;
			this.TbBright.Minimum = 40;
			this.TbBright.Name = "TbBright";
			this.TbBright.Size = new System.Drawing.Size(154, 22);
			...
			this.TBBlue.Location = new System.Drawing.Point(62, 69);
			this.TBBlue.Margin = new System.Windows.Forms.Padding(0);
			this.TBBlue.Maximum = 160;
			this.TBBlue.Minimum = 40;
			this.TBBlue.Name = "TBBlue";
			this.TBBlue.Size = new System.Drawing.Size(154, 22);
			...
			this.TbThreshold.Location = new System.Drawing.Point(62, 157);
			this.TbThreshold.Margin = new System.Windows.Forms.Padding(0);
			this.TbThreshold.Name = "TbThreshold";
			this.TbThreshold.Size = new System.Drawing.Size(154, 22);
			...
			this.TBWhiteClip.Location = new System.Drawing.Point(62, 135);
			this.TBWhiteClip.Margin = new System.Windows.Forms.Padding(0);
			this.TBWhiteClip.Name = "TBWhiteClip";
			this.TBWhiteClip.Size = new System.Drawing.Size(154, 22);
