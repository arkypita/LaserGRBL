...
{
	class RJCPSerial : IComWrapper
	{
		private RJCP.IO.Ports.SerialPortStream com = null;
		...
		public void Open()
		{
			if (!IsOpen)
			{
				...
				try
				{
					com = new RJCP.IO.Ports.SerialPortStream();
					com.PortName = mPortName;
					com.BaudRate = mBaudRate;
					com.DataBits = 8;
					com.Parity = RJCP.IO.Ports.Parity.None;
					com.StopBits = RJCP.IO.Ports.StopBits.One;
					com.Handshake = RJCP.IO.Ports.Handshake.None;
					com.NewLine = "\n";
