...
namespace LaserGRBL.SvgConverter
{
    class GCodeFromSVG
    {
        ...
        public string convertFromText(string text, bool importMM = false)
        {
            ...
            importInMM = importMM;
            return convertSVG(svgCode, "from text");                   // startConvert(svgCode);
        }
        public string convertFromFile(string file)
        {
            importInMM = true; //Properties.Settings.Default.importUnitmm;
            if (file == "")
        ...
        private string convertSVG(XElement svgCode, string info)
        {
