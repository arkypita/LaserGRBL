...
namespace LaserGRBL
{
    ...
    public partial class ConnectLogForm : System.Windows.Forms.UserControl
    {
        ...
        /// <summary>
        /// Set the repo to the mqtt
        /// </summary>
        /// <param name="mqttRepo"></param>
        public void SetMqtt(MqttRepository mqttRepo)
        {
            this.mqtt = mqttRepo;
        }
        ...
        /// <summary>
        /// Initialize the port if not done yet.
        /// </summary>
        private void EnsurePortIsInitialized()
        {
        ...
        /// <summary>
        /// Send to the MqttServer
        /// </summary>
        /// <param name="core"></param>
        private void SendDataToMqttserver(GrblCore core)
        {
            // Because the timer starts befor the mqtt server may be assigned, so I'll do a  null check here
            if (this.mqtt != null)
            {
                this.mqtt.SendData(core);
            }
        }

        /// <summary>
        /// Updates the State of the Progress and state
        /// </summary>
