namespace LaserGRBL
{
	partial class LaserUsage
	{
		...
		private void InitializeComponent()
		{
			...
			this.tableLayoutPanel3.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 69.64029F));
            ...
            this.ChDateStartM,
            this.ChDateEndL});
			this.LVLasers.Dock = System.Windows.Forms.DockStyle.Fill;
			...
			this.ChBrand.Width = 80;
			// 
			// ChModel
			// 
			this.ChModel.Text = "Model";
			this.ChModel.Width = 80;
			// 
			// ChRunTime
			// 
			this.ChRunTime.Text = "Run Time";
			this.ChRunTime.Width = 80;
			// 
			// ChPowerTime
			// 
			...
			// ChAvgPow
			// 
			this.ChAvgPow.Text = "Avg Pow";
			this.ChAvgPow.Width = 80;
			// 
			// ChDateBuy
			// 
			this.ChDateBuy.Text = "Purchase Date";
			this.ChDateBuy.Width = 90;
			// 
			// ChDateStartM
			// 
			this.ChDateStartM.Text = "Monitoring Start";
			this.ChDateStartM.Width = 90;
			// 
			// ChDateEndL
			// 
			this.ChDateEndL.Text = "Death Date";
			this.ChDateEndL.Width = 90;
			// 
			// tableLayoutPanel5
			// 
			...
			this.tableLayoutPanel5.Location = new System.Drawing.Point(3, 419);
