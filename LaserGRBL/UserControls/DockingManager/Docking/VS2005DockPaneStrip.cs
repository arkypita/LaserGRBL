	...
	internal class VS2005DockPaneStrip : DockPaneStripBase
	{
		...
		private void DrawTab_ToolWindow(Graphics g, TabVS2005 tab, Rectangle rect)
		{
			...
			if (DockPane.ActiveContent == tab.Content)
			{
				...
				using (LinearGradientBrush B = new LinearGradientBrush(rectTab, startColor, endColor, gradientMode))
					g.FillPath(B, path);
		...
		private void DrawTab_Document(Graphics g, TabVS2005 tab, Rectangle rect)
		{
            ...
            if (DockPane.ActiveContent == tab.Content)
            {
				...
				using (LinearGradientBrush B = new LinearGradientBrush(rectBack, startColor, endColor, gradientMode))
					g.FillPath(B, path);
