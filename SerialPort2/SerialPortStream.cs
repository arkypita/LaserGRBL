...
namespace RJCP.IO.Ports
{
    ...
    public partial class SerialPortStream : Stream, ISerialPortStream
    {
        ...
        public string PortName
        {
            ...
            {
                if (IsDisposed) throw new ObjectDisposedException("SerialPortStream");
                if (value == null || value.Trim() == "") throw new ArgumentException("Must provide a valid name for a COM port");
        ...
        protected override void Dispose(bool disposing)
        {
            ...
            if (disposing) {
				...
				(m_EventProcessing as IDisposable)?.Dispose();
        ...
        public override string ToString()
        {
            ...
            if (PortName == null || PortName.Trim() == "") return "SerialPortStream: Invalid configuration";
		...
		{
			//CopyTo(this, destination, DefaultBufferSize, _ => { });
		}

		public void CopyTo(Stream destination, int bufferSize)
		{
			//CopyTo(this, destination, bufferSize, _ => { });
		}

		public void CopyTo(Stream destination, Action<long> reportProgress)
		{
			//CopyTo(this, destination, DefaultBufferSize, reportProgress);
		}

		public static long CopyTo(Stream source, Stream destination, int bufferSize, Action<long> reportProgress)
		{
